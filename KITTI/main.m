...
%   l- velodyne
%      l- <0xxxx.bin>
data_path = 'E:\working\SLAMdata\KITTI\data_odometry_velodyne\dataset\sequences\00\'; 
...
hold on;
scatter(data_poses(revisitness_index,1), data_poses(revisitness_index,2),'filled');
axis equal;
